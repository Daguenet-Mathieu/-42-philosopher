...
check_number_of_forks ()
{
	...
	sleep 1
	forks=$(pgrep -P $(pgrep philo_bonus | head -1) | wc -l)
    if [ "$forks" -eq ${params[0]} ];then
        echo -e "${green}[+] Test #${test_number} Succeeded: Program created $forks forks with ${params[@]} ${reset}\n"
    else
...
if [ "$2" -eq 1 -o "$2" -eq 0 ];then
	...
	check_cpu_usage "$target" "$1" "100" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "150" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "200" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "250" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "300" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "350" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "400" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "450" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "500" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "550" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "600" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "650" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "700" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "750" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "800" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "850" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "900" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "950" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "1000" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "1050" "800" "200" "200" "70" "20"
	check_cpu_usage "$target" "$1" "1100" "800" "200" "200" "70" "20"
